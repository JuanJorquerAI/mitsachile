...
- Lee `CLAUDE.md` en la raíz del repo — extrae el alcance del proyecto, la regla de oro de contenido, y la lista de "Decisiones ya tomadas" / "Decisiones abiertas" que trae al final.
...
- No inventes ni asumas datos que no estén en `CLAUDE.md`, `docs/DECISIONS.md`, `content/00-sitemap.md` o los archivos `content/*.md` existentes.
- Si alguno de los archivos base (`CLAUDE.md`, `docs/DECISIONS.md`, `content/00-sitemap.md`) no existe o no se puede leer, dilo explícitamente al inicio del resumen en vez de omitirlo en silencio.
